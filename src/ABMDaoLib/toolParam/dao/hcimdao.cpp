...
//bool HCIMDao::add(QSharedPointer<HCIM> entity)
//{
...
//bool HCIMDao::updateById(QSharedPointer<HCIM> entity)
//{
//  if(entity->getId() == 0){
//    qDebug() << "id 不能为0";
//    return false;
...
//QList<QSharedPointer<HCIM> > HCIMDao::findList(QVector<SqlCondition> &conditions)
//{
//  QList<QMap<QString,QVariant>> dataList;
//  ABMDaoLib::getInstance()->getSqlUtils()->queryDatas(m_tableName,conditions,dataList);

//  QList<QSharedPointer<HCIM>> list;
//  for(int i=0;i<dataList.size();i++){
//    QSharedPointer<HCIM> entity = QSharedPointer<HCIM>(new HCIM());
...
//HCIMPage HCIMDao::findPage(QVector<SqlCondition> &conditions, const int pageSize, const int pageNum)
//{
//  HCIMPage page;
//  SqlPage sqlPage;
...
//QSharedPointer<HCIM> HCIMDao::findById(int id)
//{
//  QVector<SqlCondition> conditions;
...
//QSharedPointer<HCIM> HCIMDao::findByWellInfoId(int wellInfoId,int runInfoId)
//{
//  QVector<SqlCondition> conditions;
