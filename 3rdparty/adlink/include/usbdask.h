...
//    2012Dec16, Jeff remove NUM_MODULE_TYPE enumeration
    ...
    typedef struct _CAL_INFO_1210 {
        union {
            struct {
                ULONG AI_Offset[4]; // Offset Calibration settings for ��9V or ��1.5V
                ULONG AI_Gain[4];   // Gain Calibration settings for ��9V or ��1.5V              
            } CalInfo;
            UCHAR bValue[32];
        } CalInfo_1210;
    }
...
#define P2405_AI_ConfigureIEPE         	(P2405_AI_EnableIEPE|P2405_AI_Coupling_AC|P2405_AI_Differential)
