#include "runinfogeneraldao.h"
#include "../../abmdaolib.h"

//RunInfoGeneralDao::RunInfoGeneralDao()
//{

//}

//bool RunInfoGeneralDao::add(QSharedPointer<RunInfoGeneral> entity)
//{
...
//bool RunInfoGeneralDao::updateById(QSharedPointer<RunInfoGeneral> entity)
//{
//  if(entity->getId() == 0){
//    qDebug() << "id 不能为0";
//    return false;
...
//QList<QSharedPointer<RunInfoGeneral> > RunInfoGeneralDao::findList(QVector<SqlCondition> &conditions)
//{
//  QList<QMap<QString,QVariant>> dataList;
//  ABMDaoLib::getInstance()->getSqlUtils()->queryDatas(m_tableName,conditions,dataList);

//  QList<QSharedPointer<RunInfoGeneral>> list;
//  for(int i=0;i<dataList.size();i++){
//    QSharedPointer<RunInfoGeneral> entity = QSharedPointer<RunInfoGeneral>(new RunInfoGeneral());
...
//RunInfoGeneralPage RunInfoGeneralDao::findPage(QVector<SqlCondition> &conditions, const int pageSize, const int pageNum)
//{
//  RunInfoGeneralPage page;
//  SqlPage sqlPage;
...
//QSharedPointer<RunInfoGeneral> RunInfoGeneralDao::findById(int id)
//{
//  QVector<SqlCondition> conditions;
...
//QList<QSharedPointer<RunInfoGeneral> > RunInfoGeneralDao::findByWellInfoId(int wellInfoId)
//{
//  QVector<SqlCondition> conditions;
...
//QSharedPointer<RunInfoGeneral> RunInfoGeneralDao::findByRun(int wellInfoId,QString run)
//{
//  QVector<SqlCondition> conditions;
//  conditions.append(SqlCondition(SqlEqual,"well_info_id",wellInfoId));
//  conditions.append(SqlCondition(SqlEqual,"run",run));
//  conditions.append(SqlCondition(SqlEqual,"is_del",0));
//  QMap<QString,QVariant> resultData;
